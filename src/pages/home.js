...
import { FaCode, FaMobile, FaCloud, FaEnvelope, FaWhatsapp } from "react-icons/fa";
    ...
    <div className="font-sans bg-gray-100 text-gray-900 min-h-screen flex flex-col">
      ...
      <header className="shadow-lg h-screen flex flex-col items-center justify-center text-center text-white px-6 bg-gradient-to-r from-blue-500 to-purple-600 bg-[length:400%_400%] animate-gradientShift">
        ...
        <button
          ...
          className="mt-6 bg-white text-blue-600 px-6 py-3 rounded-full shadow-md hover:bg-gray-200"
        >
          Get Started
        </button>
      ...
      {/* Services Section (Scroll Target) */}
      <section ref={servicesRef} className="py-12 sm:py-20 bg-white text-center px-4 sm:px-6">
